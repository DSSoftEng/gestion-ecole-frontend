...
import { addTeacher } from '../../../store/features/teachers/TeacherAction';
...
import { fetchFillieres } from "../../../store/features/filliere/FilliereAction";
 function AddTeacher(){
  ...
  const handleSubmit = (e) => {
   e.preventDefault();
   dispatch(addTeacher({ professeur: formData, filliereId: formData.filliereId })).then(() => {
       navigate('/admindashbord/showteacher');  // Redirect to the dashboard after adding the teacher
   });
};
